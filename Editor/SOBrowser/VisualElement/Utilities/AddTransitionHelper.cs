...
namespace Long18.Editor.Tools.Editor.SOBrowser.VisualElement.Utilities
{
    internal class AddTransitionHelper : IDisposable
    {
        ...
        private readonly CardTableEditor _editor;
        private bool _toggle = false;

        internal AddTransitionHelper(CardTableEditor editor)
        {
            _editor = editor;
        ...
        {
            public AssetEntry Item = default;
        }
    }
}